...
public class MediaStyleHelper {
    ...
    public static final String AUDIO_PLAYER_CHANNEL_ID = "AUDIO_PLAYER_CHANNEL_ID";
    ...
    public static NotificationCompat.Builder from(Context context, MediaSessionCompat mediaSession) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, AUDIO_PLAYER_CHANNEL_ID);
        builder
